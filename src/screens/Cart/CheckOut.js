...
export default function CheckoutScreen({ navigation }) {
  ...
  const defaultAddressArray = useSelector((state) => state.address.defaultAddress);
  const defaultAddress = Array.isArray(defaultAddressArray) && defaultAddressArray.length > 0
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 140 }}>
          ...
          {defaultAddress ? (
            <>
              ...
              <Text style={styles.addrDetails}>
                {defaultAddress.house}, {defaultAddress.street}, {defaultAddress.city},{" "}
        ...
        {discountApplied && <Text style={styles.discountMsg}>✔ Discount Applied</Text>}
        ...
        <View style={styles.summary}>
          ...
          {discountApplied ? <Row label="Discount" value={`${total}-${discount}%`} /> : null}
        ...
        <View style={styles.policies}>
          ...
          <Text style={styles.policyText}>• Easy return & exchange process</Text>
          <Text style={styles.policyText}>• 30-day return policy</Text>
        </View>

        {/* Payment Options */}
        <View style={styles.paymentRow}>
          <TouchableOpacity style={[styles.payBtn, { backgroundColor: "#027fd8ff" }]}
            onPress={() => {
              defaultAddress ? (
          ...
          >
            <Text style={[styles.payText, { color: "#fff" }]}>Cash on Delivery</Text>
          </TouchableOpacity>
        </View>
...
const Row = ({ label, value, bold, totalStyle }) => (
  <View style={styles.row}>
    <Text style={[styles.label, bold && { fontWeight: "700", fontSize: 16 }]}>{label}</Text>
    <Text style={[styles.value, bold && { fontWeight: "700", fontSize: 16 }, totalStyle && { color: "#E64A19" }]}>{value}</Text>
  </View>
);
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 16, fontWeight: "700", paddingHorizontal: 20, paddingTop: 20, color: "#111" },
  ...
  item: { flexDirection: "row", alignItems: "center", marginHorizontal: 16, marginVertical: 6, padding: 12, borderRadius: 10, backgroundColor: "#f9f9f9" },
  ...
  discountRow: { flexDirection: "row", alignItems: "center", marginHorizontal: 16, marginTop: 20 },
  input: { flex: 1, borderWidth: 1, borderColor: "#ddd", borderRadius: 8, padding: 10, marginRight: 8 },
  applyBtn: { backgroundColor: "#111", paddingHorizontal: 16, paddingVertical: 10, borderRadius: 8 },
  ...
  paymentRow: { flexDirection: "row", justifyContent: "space-between", marginHorizontal: 16, marginTop: 20 },
  payBtn: { flex: 1, paddingVertical: 14, borderRadius: 8, alignItems: "center", marginHorizontal: 4 },
  payText: { fontWeight: "700", fontSize: 14, color: "#fff" },

  othersBtn: { backgroundColor: "#111", marginHorizontal: 16, marginTop: 12, paddingVertical: 14, borderRadius: 8, alignItems: "center" },
